...
As known, building a system's \textit{conceptual model} means to describe it highlighting which state variables are important and specifying how they are interrelated.\footnote{\textit{Ibid.}}
...
We prefer to omit a detail descriptions of Java classes involved into charts generation because they are just scripts and therefore not relevant from conceptual point of view. 
