...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./ALG1/Cloudlet_AverageClass1Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/ScatterPlot_Cloudlet_AverageClass1Population.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./ALG1/BM_Cloudlet_AverageClass1Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/H_Cloudlet_AverageClass1Population.png} }}%
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./ALG1/Cloudlet_AverageClass2Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/ScatterPlot_Cloudlet_AverageClass2Population.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./ALG1/BM_Cloudlet_AverageClass2Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/H_Cloudlet_AverageClass2Population.png} }}%
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./ALG1/Cloud_AverageClass1Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/ScatterPlot_Cloud_AverageClass1Population.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./ALG1/BM_Cloud_AverageClass1Population.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./ALG1/H_Cloud_AverageClass1Population.png} }}%
