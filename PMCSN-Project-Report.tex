...
In thi s last section we will develop an analytical solution to validate the results obtained previously through our simulations. 
...
\begin{adjustbox}{center=\textwidth}
	 ...
	 $E[N^{(2)}$ & $26.253591551$ & To big to be represented! \\
	 
	 &&\\\hline &&\\
	 
	 $E[N]$ & $35.146304546$ & To big to be represented! \\
	 ...
	 $E[T^{(2)}]$, $E[S^{(2)}]$ & $4.079733115$ & To big to be represented!  \\

	 &&\\\hline &&\\

	 $E[T]$, $E[S]$ & $3.355223899$ & To big to be represented!  \\
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloudlet_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloudlet_Class1JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloudlet_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloudlet_Class1JobsNumber.png} }}%
    \caption{Cloudlet Time-Average Class 1 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry  
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloud_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloud_Class1JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloud_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloud_Class1JobsNumber.png} }}%
    \caption{Cloud Time-Average Class 1 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsGlobalNetwork_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotGlobalNetwork_Class1JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansGlobalNetwork_Class1JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsGlobalNetwork_Class1JobsNumber.png} }}%
    \caption{Global Time-Average Class 1 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloudlet_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloudlet_Class2JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloudlet_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloudlet_Class2JobsNumber.png} }}%
    \caption{Cloudlet Time-Average Class 2 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry  
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloud_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloud_Class2JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloud_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloud_Class2JobsNumber.png} }}%
    \caption{Cloud Time-Average Class 2 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsGlobalNetwork_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotGlobalNetwork_Class2JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansGlobalNetwork_Class2JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsGlobalNetwork_Class2JobsNumber.png} }}%
    \caption{Global Time-Average Class 2 Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloudlet_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloudlet_JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloudlet_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloudlet_JobsNumber.png} }}%
    \caption{Cloudlet Time-Average Class Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry  
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsCloud_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotCloud_JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansCloud_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsCloud_JobsNumber.png} }}%
    \caption{Cloud Time-Average Class Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\begin{figure}[h!]
    \centering
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/EnsembleStatisticsGlobalNetwork_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/ScatterPlotGlobalNetwork_JobsNumber.png} }}%
    
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/BatchMeansGlobalNetwork_JobsNumber.png} }}%
    \subfloat{{\includegraphics[width=9cm]{./GraphicsAlg1/HistogramsGlobalNetwork_JobsNumber.png} }}%
    \caption{Global Time-Average Class Job Population. (Algorithm 1)}%
    \label{fig:example}
\end{figure}
\restoregeometry 
...
\subsubsection{Time-Average Class 1 Job Service/Response Time. (Algorithm 1)}
...
\newpage
\newgeometry{top=10mm, left=8mm, right=8mm}
\subsubsection{Time-Average Class 2 Job Service/Response Time. (Algorithm 1)}
...
\newpage
\newgeometry{top=10mm, left=8mm, right=8mm}
\subsubsection{Time-Average Service/Response Time. (Algorithm 1)}
...
\newpage
\newgeometry{top=10mm, left=8mm, right=8mm}
\subsubsection{Class 1 Job Throughput. (Algorithm 1)}
...
\newpage
\newgeometry{top=10mm, left=8mm, right=8mm}
\subsubsection{Class 2 Job Throughput. (Algorithm 1)}
...
\newpage
\newgeometry{top=10mm, left=8mm, right=8mm}
\subsubsection{Throughput. (Algorithm 1)}
